...
public class scenario3Test {
    ...
    private static String[] payloadSchemas; 

    @BeforeAll
    public static void beforeClass() throws IOException {
        String filePath = "scenario3Test.csv";
        BufferedReader csvReader = new BufferedReader(new FileReader(filePath));
        payloadSchemas = csvReader.readLine().split("\\^\\|\\^");
        csvReader.close();
    }
    ...
    @Test
    public void testCreatePetWithBody() throws IOException {
        String filePath = "scenario3Test.csv";
        BufferedReader csvReader = new BufferedReader(new FileReader(filePath));
        String row;
        ...
        while ((row = csvReader.readLine()) != null) {
            ...
            String actualReqBody = StringUtils.substringBetween(data[3], "{", "}");
            String url = data[1];
            ...
            Assertions.assertEquals(Integer.parseInt(data[4]), response.getStatusCode());

            String expectedBody = StringUtils.substringBetween(data[5], "{", "}");
            Assertions.assertTrue(response.getBody().asString().contains(expectedBody));
        }
