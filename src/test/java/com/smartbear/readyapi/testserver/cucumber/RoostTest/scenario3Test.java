...
public class Scenario3Test {
    @Test
    @DisplayName("Test Scenario: Create pet with body")
    public void createPet() throws IOException, JSONException, ParseException {

        String baseUri = System.getenv("API_HOST");
        RestAssured.baseURI = baseUri;
        
        String csvFile = "scenario3Test.csv";
        ...
        if ((line = br.readLine()) != null) {
            while ((line = br.readLine()) != null) {
                ...
                // Convert stringified JSON to JSONObject
                JSONParser parser = new JSONParser();
                JSONArray headers = (JSONArray) parser.parse(req_headers);
                JSONArray body = (JSONArray) parser.parse(req_body);
                ...
                if (method.equals("POST")) {
                    ...
                    JSONArray expectedResponseBody = (JSONArray) parser.parse(response_body);
                    Assertions.assertEquals(expectedResponseBody, response.getBody().jsonPath().get());
                }
            }
        }  
    }
